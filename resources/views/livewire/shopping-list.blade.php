                ...
                <ul class="flex gap-5 flex-col bg-neutral rounded-lg p-5">
                    ...
                    <form wire:submit.prevent="add_item">
                        ...
                        <div class="flex gap-5">
                            <input type="text" name="product" placeholder="Type a product here" class="text-white input input-bordered" wire:model.lazy="product">
                        ...
                        <div class="mt-4">
                            <span class="text-red-400">Note: to add a price to item, follow the item name with a '/{pice of item}'</span>
                        </div>
                    </form>  
                    @endif
                    @if($active_list)
                    ...
                    @endif
                        <form wire:submit.prevent="create_list">
                            ...
                            <div class="flex gap-5 flex-col">
                                ...
                                <input type="text" class="input input-bordered" wire:model.lazy="list_name" placeholder="Type a list name here">
